        ...
        _ret.add(new Object[]{
                ...
                this.createNewData("hallo \" test")
                        .newTable("my table \"test\"")
                                ...
                                .newField("scale 50")               .setSingle("scale", "50.0").getFormTable()
                                .newField("scale 50.5")             .setSingle("scale", "50.5").getFormTable()
                                .newField("no size")                .setSingle("size","").getFormTable()
                                .newField("size 1 1")               .setSingle("size","1 1").getFormTable()
                                .newField("size 0.5 0.5")           .setSingle("size","0.5 0.5").getFormTable()
                                .newField("size 100 59")            .setSingle("size","100 59").getFormTable()
                                .newField("no minimum size")        .setSingle("minsize", "").getFormTable()
                                .newField("minimum size 0 0")       .setSingle("minsize", "0 0").getFormTable()
                                .newField("minimum size 0.5 0.5")   .setSingle("minsize", "0.5 0.5").getFormTable()
                                .newField("minimum size 100 59")    .setSingle("minsize", "100 59").getFormTable()
                                .newField("default auto height")    .setSingle("autoheight", "").getFormTable()
                                .newField("auto height true")       .setSingle("autoheight", "true").getFormTable()
                                .newField("auto height false")      .setSingle("autoheight", "false").getFormTable()
                                .newField("default auto width")     .setSingle("autowidth", "50.0").getFormTable()
                                .newField("auto width true")        .setSingle("autowidth", "true").getFormTable()
                                .newField("auto width false")       .setSingle("autowidth", "false").getFormTable()
                                .newField("default (none) sorttype").setSingle("sorttype", "").getFormTable()
                                .newField("sorttype alpha")         .setSingle("sorttype", "alpha").getFormTable()
                                .newField("sorttype numeric")       .setSingle("sorttype", "numeric").getFormTable()
                                .newField("sorttype other")         .setSingle("sorttype", "other").getFormTable()
                                .newField("sorttype none")          .setSingle("sorttype", "none").getFormTable()
                                .newField("default not editable")   .setSingle("edit", "").getFormTable()
                                .newField("editable ")              .setSingle("edit", "true").getFormTable()
                                .newField("not editable")           .setSingle("edit", "false").getFormTable()
                                .getUser()});
        _ret.add(new Object[]{
