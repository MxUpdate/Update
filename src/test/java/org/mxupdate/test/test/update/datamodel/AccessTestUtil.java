                ...
                if ((test.getVersion() != Version.V6R2011x)
                    ...
                    ret.add(new Object[]{
                            ...
                            _test.createTestData4Access(
                                                new Access()
                                                        .setPrefix(prefix)
                                                        .setKind(kind)
                                                        .setUser("user".equals(kind) ? new PersonData(test, "creator") : null)
                                                        .addAccess("read", "show"))});
                    ret.add(new Object[]{
                    ...
                    ret.add(new Object[]{
                            ...
                            _test.createTestData4Access(
                                                ...
                                                new Access()
                                                        .setKind("user")
                                                        .setUser(new PersonData(test, "guest"))
                                                        .addAccess("read", "show"))});
                    ret.add(new Object[]{
                    ...
                    final PersonData tmpUser = "user".equals(kind) ? new PersonData(test, "creator") : null;
                    ret.add(new Object[]{
