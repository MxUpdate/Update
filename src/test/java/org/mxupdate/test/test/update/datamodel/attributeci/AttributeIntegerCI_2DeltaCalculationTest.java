    ...
    public Object[][] getData()
    {
        return new Object[][] {
            {"1a) new package",
                    ...
                    new AttributeData(this, "Test").setSingle("kind", "integer").defData("package", new PackageData(this, "TestPackage"))},
            {"1b) update package",
                    new AttributeData(this, "Test").setSingle("kind", "integer").defData("package", new PackageData(this, "TestPackage1")),
                    new AttributeData(this, "Test").setSingle("kind", "integer").defData("package", new PackageData(this, "TestPackage2"))},
            {"1c) remove package",
                    new AttributeData(this, "Test").setSingle("kind", "integer").defData("package", new PackageData(this, "TestPackage")),
                    new AttributeData(this, "Test").setSingle("kind", "integer").defKeyNotDefined("package")},
            {"2) uuid",
                    new AttributeData(this, "Test").setSingle("kind", "integer"),
                    new AttributeData(this, "Test").setSingle("kind", "integer").setValue("uuid", "FDA75674979211E6AE2256B6B6499611")},
            {"3a) symbolic name",
                    new AttributeData(this, "Test").setSingle("kind", "integer"),
