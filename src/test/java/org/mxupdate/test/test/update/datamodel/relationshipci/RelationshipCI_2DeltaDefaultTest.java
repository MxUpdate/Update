...
/**
 * Tests the {@link Relationship_mxJPO group CI} delta calculation for
 * default values.
 *
 * @author The MxUpdate Team
 */
@Test()
public class RelationshipCI_2DeltaDefaultTest
    extends AbstractDeltaNoChangeTest<Relationship_mxJPO,RelationshipData>
{
    @Override()
