...
/**
 * Tests the object generator CI export / update.
 *
 * @author The MxUpdate Team
 */
@Test()
public class ObjectGeneratorCI_3UpdateTest
    extends AbstractBusUpdateTest<BusData>
{
    ...
    {
        return new BusData(this, CI.DM_OBJECTGENERATOR, _name, _revision);
    }
    ...
    {
        this.cleanup(CI.DM_OBJECTGENERATOR);
