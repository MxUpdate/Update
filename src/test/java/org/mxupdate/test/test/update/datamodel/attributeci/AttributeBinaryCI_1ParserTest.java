    ...
    extends AbstractParserTest<AttributeCI_mxJPO>
{
    ...
    public Object[][] getData()
    {
        return new Object[][]
        {
            ...
            {"1a) package string",
                    "",
                    "package \"abc\" kind binary description \"\" !hidden !resetonclone !resetonrevision default \"\""},
            {"1b) package single",
                    "package \"abc\" kind binary description \"\" !hidden !resetonclone !resetonrevision default \"\"",
                    "package abc     kind binary description \"\" !hidden !resetonclone !resetonrevision default \"\""},
            // uuid
            ...
            {"6a) multivalue defined, but must be ignored",
                    "kind binary description \"\" !hidden             !resetonclone !resetonrevision default \"\"",
                    "kind binary description \"\" !hidden !multivalue !resetonclone !resetonrevision default \"\""},
            {"6b) multivalue defined, but must be ignored",
                    "kind binary description \"\" !hidden             !resetonclone !resetonrevision default \"\"",
                    "kind binary description \"\" !hidden  multivalue !resetonclone !resetonrevision default \"\""},
            // resetonclone flag
            {"7a) resetonclone",
