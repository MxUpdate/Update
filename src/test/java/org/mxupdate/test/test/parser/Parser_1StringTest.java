 ...
 */
public class Parser_1StringTest
{
    /**
    ...
    public void positiveTest(final String _description,
        ...
        throws Exception
    {
        Assert.assertEquals(_expString, new ParserTestImpl(new StringReader("string " + _parsingString)).test1String());
    }
    ...
    public void negativeTest(final String _description,
        ...
        throws Exception
    {
        new ParserTestImpl(new StringReader("string " + _parsingString)).test1String();
    }
}
