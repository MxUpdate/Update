...
this.appendValue(_interface, "types",                          this.getSingle(tmp.image));
      ...
      case LOCAL:{
        ...
        case STRING:{
          tmp = jj_consume_token(STRING);
localAttr = new LocalAttribute(this.getString(tmp.image));this.appendValue(_interface, "localAttributes", localAttr);
          break;
          }
        case SINGLE:{
          tmp = jj_consume_token(SINGLE);
localAttr = new LocalAttribute(this.getSingle(tmp.image));this.appendValue(_interface, "localAttributes", localAttr);
          break;
          }
        default:
          jj_la1[10] = jj_gen;
