...
public class DimensionDefParser_mxJPO
    extends AbstractParser_mxJPO<Dimension_mxJPO> implements DimensionDefParserConstants_mxJPO {
...
this.setValue(_dimension, "description", this.getString(tmpToken.image));
          break;
          }
        case DESCRIPTION_SINGLE:{
          tmpToken = jj_consume_token(DESCRIPTION_SINGLE);
this.setValue(_dimension, "description", this.getSingle(tmpToken.image));
          break;
          }
        default:
          jj_la1[1] = jj_gen;
...
tmpProp = new AdminProperty();this.appendValue(this.getValue(_dimension, "properties"), "propertiesStack", tmpProp);
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
 ...
 */
  final public void unit(final Dimension_mxJPO _dimension) throws ParseException {final Unit unit = new Unit();
    Token tmpToken;
    String tmpStr;
