...
property = new AdminProperty();
                                                                this.appendValue(this.getValue(_command, "properties"), "propertiesStack", property);
...
this.setValue(_command, "code", this.getSingle(tmp.image));
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x40ffe0,0x30000,0x30000,0xc0000,0x30000,0x30000,0x30000,0x30000,0x300000,0x30000,0x30000,0x1800000,0x30000,0x6000000,0x30000,0x1800000,0xc0000,0x40ffe0,};
   }
