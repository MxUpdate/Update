/* CommandParserTokenManager.java */
...
/** Token Manager. */
@SuppressWarnings("unused")class CommandParserTokenManager_mxJPO implements CommandParserConstants_mxJPO {
...
private int jjMoveStringLiteralDfa2_4(long old0, long active0){
   ...
   switch(curChar)
   {
      ...
      case 100:
         return jjMoveStringLiteralDfa3_4(active0, 0x10200L);
      case 101:
...
static final int[] jjnextStates = {
   16, 6, 19, 13, 17, 20, 1, 2, 4, 5, 6, 7, 8, 9, 10, 7, 
   8, 9, 10, 11, 12, 
};
...
"\150\162\145\146", "\154\141\142\145\154", null, null, "\143\157\144\145", null, null, null, null, 
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public CommandParserTokenManager_mxJPO(SimpleCharStream stream){
  ...
  /** Constructor. */
  public CommandParserTokenManager_mxJPO (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
...
public static final int[] jjnewLexState = {
   -1, -1, -1, -1, -1, 3, 3, 3, 2, -1, -1, 3, 3, 3, 3, 1, 2, 4, 4, 4, 4, 3, 3, 3, 0, 
   3, 3, 3, 
};
