...
public class ChannelDefParser_mxJPO
    extends AbstractParser_mxJPO<Channel_mxJPO> implements ChannelDefParserConstants_mxJPO {
 ...
 */
  final public void parse(Channel_mxJPO _menu) throws ParseException, SecurityException, IllegalArgumentException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {Token tmp;
...
this.setValue(_menu, "height", Integer.valueOf(tmp.image));
        break;
        }
      case SETTING:{
...
this.setValue(property, "refAdminName", this.getSingle(tmp.image));
  ...
  public ChannelDefParserTokenManager_mxJPO token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7fe0,0x600000,0x600000,0x600000,0x600000,0x0,0x600000,0x600000,0x600000,0x18000,0x600000,0x0,0x600000,0x18000,0x7fe0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0xc,0x0,0x0,0x0,0x0,0x0,0xc00,0x0,0x0,0x0,};
   }

  /** Constructor with InputStream. */
  public ChannelDefParser_mxJPO(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ChannelDefParser_mxJPO(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ChannelDefParserTokenManager_mxJPO(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ChannelDefParser_mxJPO(java.io.Reader stream) {
  ...
  public ChannelDefParser_mxJPO(ChannelDefParserTokenManager_mxJPO tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ChannelDefParserTokenManager_mxJPO tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
